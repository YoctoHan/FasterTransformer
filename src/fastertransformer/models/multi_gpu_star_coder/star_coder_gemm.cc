...
#include "src/fastertransformer/utils/gemm_test/star_coder_gemm_func.h"
...
{
    if (argc < 9 || argc > 11) {
        FT_LOG_ERROR("./bin/star_coder_gemm batch_size \\ \n"
                     "               beam_width \\ \n"
                     "               max_input_len \\ \n"
                     "               head_number \\ \n"
                     "               size_per_head \\ \n"
        ...
        FT_LOG_ERROR("e.g. ./bin/star_coder_gemm 8 4 32 96 128 49152 51200 1 8 1");
        return 0;
    }
    ...
    void*  gemm_test_buf;
    size_t buf_size_in_byte = ft::calStarCoderGemmTestBufSizeInByte(batch_size,
                                                              beam_width,
                                                              max_input_len,
                                                              head_num,
                                                              size_per_head,
    ...
    if (data_type == ft::FLOAT_DATATYPE) {
        ft::generate_star_coder_gemm_config<float>(batch_size,
                                            beam_width,
                                            max_input_len,
                                            head_num,
                                            size_per_head,
        ...
        ft::generate_star_coder_gemm_config<half>(batch_size,
                                           beam_width,
                                           max_input_len,
                                           head_num,
                                           size_per_head,
        ...
        ft::generate_star_coder_gemm_config<__nv_bfloat16>(batch_size,
                                                    beam_width,
                                                    max_input_len,
                                                    head_num,
                                                    size_per_head,
        ...
        ft::generate_star_coder_gemm_config<__nv_fp8_e4m3>(batch_size,
                                                    beam_width,
                                                    max_input_len,
                                                    head_num,
                                                    size_per_head,
