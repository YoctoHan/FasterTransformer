...
template<typename T>
class ParallelStarCoderDecoder: public BaseLayer {
private:
    // buffer handling
...
public:
    ParallelStarCoderDecoder(size_t                              max_batch_size,
                       size_t                              head_num,
    ...
    ParallelStarCoderDecoder(ParallelStarCoderDecoder<T> const& decoder);

    ~ParallelStarCoderDecoder();
