...
template<typename T>
class ParallelStarCoderContextDecoder: public BaseLayer {
private:
    // buffer handling
...
protected:
public:
    ParallelStarCoderContextDecoder(size_t                              max_batch_size,
                                    size_t                              max_seq_len,
                                    size_t                              head_num,
    ...
    ParallelStarCoderContextDecoder(ParallelStarCoderContextDecoder<T> const& decoder);

    ~ParallelStarCoderContextDecoder();

    void forward(TensorMap*                                            output_tensors,
                 const TensorMap*                                      input_tensors,
                 const std::vector<ParallelStarCoderDecoderLayerWeight<T>*>* decoder_layer_weights);
};
