...
template<typename T>
class ParallelStarCoder: public BaseLayer {
private:
    // meta data
    size_t                      head_num_;
    ...
    // StarCoder Variants parameters: e.g. Meta OPT
    starCoderVariantParams               star_coder_variant_params_;

    ParallelStarCoderDecoder<T>*                star_coder_decoder_;
    ParallelStarCoderContextDecoder<T>* star_coder_context_decoder_;
...
public:
    ParallelStarCoder(size_t                                            max_batch_size,
                      size_t                                               max_seq_len,
                      size_t                                             max_input_len,
                      size_t                                                beam_width,
                      size_t                                                  head_num,
    ...
    ParallelStarCoder(ParallelStarCoder<T> const& star_coder);
