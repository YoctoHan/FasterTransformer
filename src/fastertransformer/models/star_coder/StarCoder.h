...
#include "src/fastertransformer/models/star_coder/Barrier.h"
#include "src/fastertransformer/models/star_coder/StarCoderBatch.h"
#include "src/fastertransformer/models/star_coder/StarCoderContextDecoder.h"
#include "src/fastertransformer/models/star_coder/StarCoderDecoder.h"
...
private:
    void
    initialize(const StarCoderAttentionParams& attn_params, size_t kv_head_num, bool use_context_fmha, int quant_policy);
...
private:
    ...
    std::unique_ptr<StarCoderCacheManager> kv_cache_mgr_;

    StarCoderWeight<T>*            weights_{};
    StarCoderDecoder<T>*           decoder_{};
    StarCoderContextDecoder<T>*    context_decoder_{};
